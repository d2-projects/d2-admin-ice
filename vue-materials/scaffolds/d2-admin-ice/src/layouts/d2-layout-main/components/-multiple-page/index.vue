<template>
  <div class="d2-layout-main-multiple-page-group">
    <div class="d2-layout-main-multiple-page-content">
      <div class="d2-layout-main-multiple-page-content-inner">
        <el-tabs
          class="d2-layout-main-multiple-page"
          :value="pageCurrent"
          type="card"
          :closable="true"
    ...
    <div class="d2-layout-main-multiple-page-btn">
